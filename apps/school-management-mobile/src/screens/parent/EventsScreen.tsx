                    ...
                    Object.entries(grouped).map(([month, monthEvents]) => (
                        <View key={month}>
                            ...
                            {monthEvents.map((event) => {
                                ...
                                const color = EVENT_COLORS[eventType] ?? '#4F63AC';
                                return (
...
const styles = StyleSheet.create({
    ...
    monthLabel: { fontSize: 14, fontWeight: '700', color: '#4F63AC', marginTop: 8, marginBottom: 8, textTransform: 'uppercase', letterSpacing: 1 },
    eventCard: {
